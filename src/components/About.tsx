...
const slides = [
  ...
  },
  {
    title: 'AI Innovator',
    icon: Sparkles,
    accent: 'from-slate-800 to-brand-900',
    content:
  ...
  },
  {
    title: 'Impact Driver',
    icon: Lightbulb,
    accent: 'from-brand-700 to-slate-900',
    content:
      ...
      <div className="section-card overflow-hidden">
        <div className="relative min-h-[340px] sm:min-h-[380px]">
          <AnimatePresence mode="wait">
            <motion.div
              key={currentSlide}
              className={`absolute inset-0 bg-gradient-to-br ${slide.accent} p-8 sm:p-10 text-white`}
            ...
            >
              ...
              <div className="absolute top-0 right-0 h-64 w-64 translate-x-1/3 -translate-y-1/3 rounded-full bg-white/5 blur-2xl" />

              <div className="relative z-10 flex h-full flex-col justify-center">
                <div className="mx-auto max-w-3xl text-center">
                  <motion.div
                    className="mb-5 inline-flex rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur-sm"
                    initial={{ scale: 0.9, opacity: 0 }}
                    animate={{ scale: 1, opacity: 1 }}
                    transition={{ delay: 0.1, duration: 0.4 }}
                  >
                    <Icon size={28} className="text-brand-200" />
                  </motion.div>
                  ...
                  <motion.p
                    className="mt-4 text-sm sm:text-base leading-relaxed text-slate-200"
                    initial={{ opacity: 0, y: 16 }}
                    animate={{ opacity: 1, y: 0 }}
          ...
          <button
            onClick={prevSlide}
            className="absolute left-4 top-1/2 z-20 -translate-y-1/2 rounded-full border border-white/10 bg-white/10 p-2.5 text-white backdrop-blur-sm transition-colors hover:bg-white/20"
          ...
          <button
            onClick={nextSlide}
            className="absolute right-4 top-1/2 z-20 -translate-y-1/2 rounded-full border border-white/10 bg-white/10 p-2.5 text-white backdrop-blur-sm transition-colors hover:bg-white/20"
